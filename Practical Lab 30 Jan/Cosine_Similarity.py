...
def main():
    ...
    # 1️⃣ DEMO with user-specified size
    demo_size = int(input("🔢 Enter size for demo comparison (e.g., 10): "))
    ...
    # 2️⃣ Ask for list of sizes for plotting
    sizes = list(map(int, input("📊 Enter input sizes for graph (e.g., 50 100 300 500): ").split()))
    similarities = []
    times = []
